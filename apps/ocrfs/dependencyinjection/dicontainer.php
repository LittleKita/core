...
namespace OCA\OCRFS\DependencyInjection;

use OCA\AppFramework\DependencyInjection\DIContainer as BaseContainer;

use OCA\OCRFS\Controller\ReplicationController;
use OCA\OCRFS\Controller\SettingsController;
use OCA\OCRFS\Db\ItemMapper;
...
class DIContainer extends BaseContainer {
	...
	public function __construct(){
		 ...
		 * CONTROLLERS
		 */
		$this['ReplicationController'] = $this->share(function($c){
			return new ReplicationController($c['API'], $c['Request'], $c['ItemMapper']);
		});
