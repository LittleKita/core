...
(function() {
  ...
  angular.module('OCRFS', ['OC']).config([
    '$provide', '$interpolateProvider', function($provide, $interpolateProvider) {
      ...
      Config.routes = {
        saveNameRoute: 'ocrfs_ajax_setsystemvalue',
        getNameRoute: 'ocrfs_ajax_getsystemvalue'
      };
...
(function() {
  ...
  angular.module('OCRFS').filter('leetIt', function() {
...
(function() {
  ...
  angular.module('OCRFS').factory('OCRFSRequest', [
    '$http', 'Config', '_OCRFSRequest', 'Publisher', function($http, Config, _OCRFSRequest, Publisher) {
      return new _OCRFSRequest($http, Config, Publisher);
    }
  ]);

  angular.module('OCRFS').factory('ItemModel', [
    '_ItemModel', function(_ItemModel) {
      return new _ItemModel();
    }
  ]);

  angular.module('OCRFS').factory('Publisher', [
...
(function() {
  ...
  angular.module('OCRFS').factory('_OCRFSRequest', [
    '_Request', function(_Request) {
      var OCRFSRequest;
      OCRFSRequest = (function(_super) {

        __extends(OCRFSRequest, _super);

        function OCRFSRequest($http, Config, Publisher) {
          OCRFSRequest.__super__.constructor.call(this, $http, Config, Publisher);
        }

        OCRFSRequest.prototype.saveName = function(route, name) {
          var data;
          data = {
            somesetting: name
          };
        ...
        OCRFSRequest.prototype.getName = function(route, scope) {
          var success;
...
(function() {
  ...
  angular.module('OCRFS').factory('_ItemModel', function() {
    var ItemModel;
    ItemModel = (function() {
...
(function() {
  ...
  angular.module('OCRFS').factory('_ExampleController', function() {
...
(function() {
  ...
  angular.module('OCRFS').controller('ExampleController', [
    '$scope', 'Config', 'OCRFSRequest', '_ExampleController', 'ItemModel', function($scope, Config, OCRFSRequest, _ExampleController, ItemModel) {
      return new _ExampleController($scope, Config, OCRFSRequest, ItemModel);
    }
  ]);
